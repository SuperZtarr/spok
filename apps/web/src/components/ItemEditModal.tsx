...
export function ItemEditModal({
  ...
  const updateMutation = useMutation({
    mutationFn: (data: { type?: ItemType; title?: string; description?: string | null; url?: string | null; parentId?: string | null; status?: string | null; dueDate?: string | null; startDate?: string | null; endDate?: string | null; updatedAt?: string }) =>
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updates: { type?: ItemType; title?: string; description?: string | null; url?: string | null; parentId?: string | null; status?: string | null; dueDate?: string | null; startDate?: string | null; endDate?: string | null; updatedAt?: string } = {};
