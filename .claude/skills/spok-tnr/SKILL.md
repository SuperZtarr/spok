...
> **Exécution non bloquante** : `pnpm exec vitest run` (suite complète) tourne en arrière-plan (`run_in_background: true`) — jamais en foreground bloquant. Un message de Thomas doit pouvoir arriver pendant l'exécution.
