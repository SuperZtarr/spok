...
export const DEFAULT_MENU_ITEMS: MenuItemConfig[] = [
  ...
  { id: '', key: 'links', label: 'Liens', icon: 'ExternalLink', section: 'global', sectionLabel: 'Vues globales', sectionOrder: 0, route: '/links', viewMode: null, order: 7, visible: true, access: 'user' },
  ...
  { id: '', key: 'admin-api-doc', label: 'Documentation API', icon: 'FileText', section: 'admin', sectionLabel: 'Administration', sectionOrder: 4, route: '/admin/api-doc', viewMode: null, order: 8, visible: true, access: 'admin' },
