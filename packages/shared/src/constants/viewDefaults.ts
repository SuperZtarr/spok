...
export const DEFAULT_VIEW_CONFIG: ViewConfigItem[] = [
  ...
  { id: 'pert', label: 'PERT', icon: 'GitMerge', category: 'planning', order: 18, visible: true, access: 'user' },
  { id: 'members', label: 'Membres', icon: 'Users', category: 'basic', order: 19, visible: true, access: 'user' },
  { id: 'priority', label: 'Priorités', icon: 'Flame', category: 'basic', order: 20, visible: true, access: 'user' },
  { id: 'crossTable', label: 'Tableau croisé', icon: 'Table2', category: 'basic', order: 21, visible: true, access: 'user' },
  { id: 'heatmap', label: 'Heatmap', icon: 'Grid3x3', category: 'exploration', order: 22, visible: true, access: 'user' },
  { id: 'ego', label: 'Réseau ego', icon: 'Focus', category: 'exploration', order: 23, visible: true, access: 'user' },
  { id: 'links', label: 'Liens', icon: 'ExternalLink', category: 'itemTypes', order: 24, visible: true, access: 'public' },
  { id: 'images', label: 'Images', icon: 'Image', category: 'itemTypes', order: 25, visible: true, access: 'public' },
  { id: 'documents', label: 'Documents', icon: 'FileText', category: 'itemTypes', order: 26, visible: true, access: 'user' },
  { id: 'bugs', label: 'Bugs', icon: 'Bug', category: 'itemTypes', order: 27, visible: true, access: 'user' },
  { id: 'todo', label: 'Todo', icon: 'CheckSquare', category: 'itemTypes', order: 28, visible: true, access: 'user' },
  { id: 'recent', label: 'Récents', icon: 'Clock', category: 'basic', order: 29, visible: true, access: 'user' },
];
